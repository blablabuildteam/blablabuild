      ...
      <section id="cases" className="min-h-screen snap-start flex flex-col justify-center bg-white py-16 md:py-20 lg:py-24">
        ...
        >
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-bla-lime/20 rounded-full mb-4">
              <div className="w-1.5 h-1.5 bg-bla-lime rounded-full animate-pulse"></div>
              <p className="text-[10px] uppercase tracking-wider text-gray-900 font-medium">BEWEZEN RESULTATEN</p>
            </div>
        ...
        {/* Coming Soon Note */}
        <motion.div 
          className="mx-auto w-full px-6 mt-12 text-center" 
          style={{ maxWidth: '1250px' }}
          initial={{ opacity: 0 }}
